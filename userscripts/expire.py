...
#   sjekk shadow-expire
#   sammenlign, er shadow-expire mer enn 30 dager i fremtiden
#       er det 30 14 eller 7 dager til brukeren gaar ut, send mail om det til brukeren om det
...
today = math.floor(time.time() / SECONDS_IN_DAY)
